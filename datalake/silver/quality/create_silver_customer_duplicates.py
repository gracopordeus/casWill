...
comments = """
    ...
    COMMENT ON COLUMN silver.customer_id_duplicates.cotumer_id IS 'Identificação única do cliente';
    COMMENT ON COLUMN silver.customer_id_duplicates.entry_date IS 'Data de abertura da conta';
    COMMENT ON COLUMN silver.customer_id_duplicates.full_name IS 'Nome completo';
    ...
    COMMENT ON COLUMN silver.customer_id_duplicates.street_name IS 'Logradouro';
"""
