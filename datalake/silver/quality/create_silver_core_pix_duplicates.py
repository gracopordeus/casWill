...
comments = """
    ...
    COMMENT ON COLUMN silver.core_pix_id_duplicates.year IS 'Ano extraído da data de movimentação';
    COMMENT ON COLUMN silver.core_pix_id_duplicates.month IS 'Mês extraído da data de movimentação';
    COMMENT ON COLUMN silver.core_pix_id_duplicates.day IS 'Dia extraído da data de movimentação';
"""
