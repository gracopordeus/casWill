...
"""
comments = """
    COMMENT ON TABLE silver.pix_inconsistencies IS 'Tabela para armazenar informações da tabela de origem core_account com id duplicados. Esta tabela ajuda a equipe técnica a identificar e corrigir essas inconsistências caso a caso.';
